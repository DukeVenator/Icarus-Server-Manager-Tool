...
<!-- RELEASE_BLOCK -->
**Latest release:** [v1.0.6](https://github.com/DukeVenator/Icarus-Server-Manager-Tool/releases/tag/v1.0.6) — on that page, download **IcarusServerManager-v1.0.6-win-x64.zip** from **Assets** (Windows; requires [.NET 8 Desktop Runtime](https://dotnet.microsoft.com/download/dotnet/8.0)).
<!-- /RELEASE_BLOCK -->
